...
#line 74 "parse.tab.c" /* yacc.c:339  */
...
#line 130 "parse.tab.c" /* yacc.c:355  */
};
...
#line 147 "parse.tab.c" /* yacc.c:358  */
...
{
       0,    39,    39,    39,    40,    42,    44,    45,    46,    48,
      49,    51,    53,    54,    55,    57,    58,    59,    60,    62,
...
{
  "$end", "error", "$undefined", "NAMETOKEN", "NAME_INITIAL_TOKEN",
  "JRTOKEN", "SRTOKEN", "ROMANTOKEN", "IDENTIFIERTOKEN", "INTTOKEN",
  "HASHTOKEN", "COMMATOKEN", "EOLTOKEN", "DASHTOKEN", "$accept",
  "postal_addresses", "$@1", "address_block", "name_part", "personal_part",
  "last_name", "suffix_part", "street_address", "street_number",
  "street_name", "location_part", "town_name", "state_code", "zip_code", YY_NULLPTR
};
#endif
...
{
       9,   -11,   -12,   -12,     6,    -7,    -1,     8,   -12,   -12,
     -12,     7,   -12,   -12,    15,    17,   -12,    -3,     9,   -12,
     -12,   -12,   -12,    10,   -12,     5,   -12,   -12,   -12,   -12,
      11,   -12,    19,    12,    16,   -12,   -12,   -12,    18,   -12,
      14,    20,    22,   -12,    21,   -12,   -12
};
...
{
       0,     0,     9,    10,     0,     4,     0,     0,     8,     1,
       2,     0,    20,    19,     0,     0,    11,     0,     0,    18,
      23,    24,     5,     0,    21,     0,    13,    12,    14,     7,
       0,     3,     0,     0,     0,    17,     6,    25,     0,    15,
       0,    27,     0,    16,     0,    22,    26
};
...
{
      11,     8,    26,    27,    28,    10,     9,    12,    13,    29,
       1,    16,     2,     3,    33,    34,    20,    35,    21,    19,
      24,    32,    37,    36,    39,    40,    43,    41,     0,     0,
      46,    31,     0,    44,    45
};

static const yytype_int8 yycheck[] =
{
       1,    12,     5,     6,     7,    12,     0,     8,     9,    12,
       1,     3,     3,     4,     9,    10,     1,    12,     3,    12,
       3,    11,     3,    12,    12,     9,    12,     9,    -1,    -1,
       9,    18,    -1,    13,    12
};
...
{
       0,     1,     3,     4,    15,    17,    18,    19,    12,     0,
      12,     1,     8,     9,    22,    23,     3,    20,    16,    12,
       1,     3,    25,    26,     3,    24,     5,     6,     7,    12,
      21,    15,    11,     9,    10,    12,    12,     3,    27,    12,
       9,     9,    28,    12,    13,    12,     9
};
...
{
       0,    14,    16,    15,    15,    17,    18,    18,    18,    19,
      19,    20,    21,    21,    21,    22,    22,    22,    22,    23,
...
#line 53 "parse.y" /* yacc.c:1646  */
    {fprintf(stderr,"<Suffix>Sr.</Suffix>\n"); }
#line 1274 "parse.tab.c" /* yacc.c:1646  */
    break;

  case 13:
#line 54 "parse.y" /* yacc.c:1646  */
    {fprintf(stderr,"<Suffix>Jr.</Suffix>\n"); }
...
#line 62 "parse.y" /* yacc.c:1646  */
    {fprintf(stderr,"<HouseNumber>%d</HouseNumber>\n",(yyvsp[0].value)); }
...
#line 1334 "parse.tab.c" /* yacc.c:1646  */
    break;
